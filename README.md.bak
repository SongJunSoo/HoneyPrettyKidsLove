...
아이가 있는 집이라면, 아이가 칭찬받을 일을 했을 때 잔돈이 없어서 용돈을 주지 못하고 아이에게 나중에 줄게 라고
한 적이 있을 것입니다.
그런데 아이가 언제 줄거냐며 계속 보채어서 힘드셨던 경우가 있으셨나요?
제가 만들고자 하는 앱은 아이가 칭찬받을 일을 했을 때 용돈을 적립해주어 아이에게돈에 대한 경제 개념을 갖게 해주고 ,
앱에서 적립한 금액으로 아이가 사고자하는 것을 살 수 있게 하고, 적립한금액을 사용하여 하트를 구매하여 TV보기(캐리앤토이즈)등에 사용이 가능하며, 칭찬한 일에 대하여 사진첩이나 글을 남겨두어 아이에 대한 추억 사진첩으로도 사용가능한 앱을 만들고 싶습니다.
