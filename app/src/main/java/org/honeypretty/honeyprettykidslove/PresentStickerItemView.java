 ...
 */
public class PresentStickerItemView extends LinearLayout {
    TextView textView;
    TextView textView2;
    TextView textView3;
    ImageView imageView;

    public PresentStickerItemView(Context context) {
        super(context);

        init(context);
    }

    public PresentStickerItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
