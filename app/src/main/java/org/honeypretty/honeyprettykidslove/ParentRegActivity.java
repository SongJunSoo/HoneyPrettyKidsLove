...
public class ParentRegActivity extends AppCompatActivity {
    ...
    public static final String TAG = "ParentRegActivity";
...
//    }
    ...
    class goParentGaip extends AsyncTask<String,String,String> {
        ProgressDialog dialog = new ProgressDialog(ParentRegActivity.this);
        @Override
